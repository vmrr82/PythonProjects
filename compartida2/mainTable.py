...
app.layout = html.Div([
            ...
            html.Div([
                    ...
                    html.P(file['n_vehÍc'].max(),className='numeroMaxImplicados', title='Máximo número de implicados de un accidente')],
                        className='bloqImplicados'),
            html.Div([html.Img(src=r"assets/Policia_Local_Derecha.png",title='Ajuntament de Calvià - Policía Local',className="bloqIcon")])],className='header'),
            

            dbc.Row([html.Div([
                    dcc.RadioItems(id="radioItem", options=["Puntos de colisión","Heatmap"],value="Puntos de colisión"),
                    dcc.Graph(id='mapaCallback',responsive=True,config={'displaylogo':False,'displayModeBar':True,'showLink':False},
                            style={'width':'800px','height':'480px'})],className='mapa'),
                    html.Div(dcc.Graph(figure={'layout':{'paper_bgcolor':'rgb(8, 34, 85)','plot_bgcolor':'rgb(8, 34, 85)','font':{'color':'white'}}},id='figraphs',responsive=True,
                       config={'displaylogo':False,'displayModeBar':True,'showLink':False},style={'width':'600px','height':'480px'}),className='figGraphs')],className='rowOne'),
            ...
            html.Div([
                ...
                html.Div([dcc.Graph(figure={'layout':{'paper_bgcolor':'rgb(8, 34, 85)','plot_bgcolor':'rgb(8, 34, 85)','font':{'color':'white'}}},id='secondFigGraphs',
                        responsive=True,config={'displaylogo':False,'displayModeBar':True,'showLink':False},style={'width':'600px','height':'480px'})],className='secondFigGraphs')],className='rowTwo'), 
                dbc.Row([
                html.Div(id='totalFilter',className='totalFilter'),
                html.Div([html.Button(id='clear_filter',children='Limpiar Formulario',n_clicks=0,title='Limpiar Formulario')],id='filterButton')],className='rowThree')
                ],className='container')
