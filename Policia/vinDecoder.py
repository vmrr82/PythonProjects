from src.vinSource import WMIDatabase, get_region, get_country, get_year
...
class VINDecoder(object):
    def __init__(self):
        self.wmi_db = WMIDatabase("/home/vmr/Escritorio/Programacion/GitHub/Policia/src/wmi_vinquery.csv")
